...
DROP TABLE IF EXISTS SKILL_ASS_TBL;
...
CREATE TABLE SKILL_ASS_TBL
(
	skill_ass_id int NOT NULL AUTO_INCREMENT,
	assignment_id int NOT NULL,
	skill_id int NOT NULL,
	PRIMARY KEY (skill_ass_id)
);


CREATE TABLE SKILL_MAP_TBL
(
	skillmap_id int NOT NULL AUTO_INCREMENT,
	user_id int NOT NULL,
	skill_id int NOT NULL,
	-- 獲得したスキルのポイント
	-- 難易度によりポイントが変わる
	point int NOT NULL COMMENT '獲得したスキルのポイント
難易度によりポイントが変わる',
